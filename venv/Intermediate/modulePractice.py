...
from cil_module import display

img1 = cil_module.read_image('img1.txt')
img2 = cil_module.read_image('img2.txt')

inverted_img1 = cil_module.invert(img1)
inverted_img2 = cil_module.invert(img2)
